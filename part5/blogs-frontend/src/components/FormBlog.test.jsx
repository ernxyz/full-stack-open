...
describe("<FormBlog />", () => {
  ...
  test("the form calls the event handler it received as props with the right details when a new blog is created", async () => {
    ...
    render(
      <FormBlog addBlog={mockHandler} />
    )

    const userForEvent = userEvent.setup()
    const titleInput = screen.getByPlaceholderText("what's the title of your blog?")
    const urlInput = screen.getByPlaceholderText("what's the URL of your blog?")
